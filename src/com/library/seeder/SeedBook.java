...
public class SeedBook {
        public static void seed(AuthorService authorService, MasterDataService masterDataService,
                ...
                Book.Builder builder2 = new Book.Builder(
                                "Harry Potter and the Sorcerer's Stone (python)",
                                "ISBN002",
                                authorId2);
                ...
                Author author3 = new Author("George Orwell Row");
